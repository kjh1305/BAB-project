...
function checkId(){
			...
			var windowObj;
            var url="/member/idCheck.do?id="+document.userInfo.id.value;
...
<head>
  ...
  <section class="login-block">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <form action="/member/signUpProc.do" method="POST" class="md-float-material form-material" name="userInfo">
