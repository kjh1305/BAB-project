                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar" id="navBar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="/member/login.do" class="waves-effect waves-dark">
                                ...
                                <li class="">
                                    <a href="/member/signUp.do" class="waves-effect waves-dark">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu ">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="/board/boardList.do?lang=c&devide=share" class="waves-effect waves-dark">
                                        ...
                                        <li class="">
                                            <a href="/board/boardList.do?lang=c&devide=qna" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                ...
                                <li class="pcoded-hasmenu ">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="/board/boardList.do?lang=java&devide=share" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">정보공유</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        ...
                                        <li class="">
                                            <a href="/board/boardList.do?lang=java&devide=qna" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">질의응답</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                ...
                                <li class="pcoded-hasmenu ">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="/board/boardList.do?lang=python&devide=share" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">정보공유</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        ...
                                        <li class="">
                                            <a href="/board/boardList.do?lang=python&devide=qna" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">질의응답</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu ">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="/board/boardList.do?lang=php&devide=share" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">정보공유</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        ...
                                        <li class="">
                                            <a href="/board/boardList.do?lang=php&devide=qna" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">질의응답</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                ...
                                <li class="pcoded-hasmenu ">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="/board/boardList.do?lang=jsp&devide=share" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">정보공유</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        ...
                                        <li class="">
                                            <a href="/board/boardList.do?lang=jsp&devide=qna" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">질의응답</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                ...
                                <li class="pcoded-hasmenu ">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="/board/boardList.do?lang=asp&devide=share" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">정보공유</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        ...
                                        <li class="">
                                            <a href="/board/boardList.do?lang=asp&devide=qna" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">질의응답</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
